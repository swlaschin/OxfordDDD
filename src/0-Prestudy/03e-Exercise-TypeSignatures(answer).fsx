...
// val sigX = int -> 'a
// Trick question! This is not possible to implement without cheating!

// However, if you use exceptions, you can write
let sigX x =
    printfn "%i" x
...
// val sigZ = 'a -> 'b
// Again, not possible to implement without cheating!
// but if you cheat and use exceptions, you can write
let sigZ x =
    failwith "error"   // raise exception!
