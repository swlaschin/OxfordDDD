// =================================
// Railway oriented programming pipeline with custom error type
//
// Exercise:
//    Convert this pipeline to use a custom Error type rather than strings
//
...
#load "RopUtil.fsx" // TIP evaluate this import separately before evaluating the rest of the code below
