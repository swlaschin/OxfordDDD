...
type ITurtle =
    ...
    abstract member Angle ??  // what goes here?
    abstract member Position: Position

    abstract member PenUp: ?? -> ??  // what goes here?
    abstract member PenDown: ??  // what goes here?
...
type Turtle() =
    ...
    interface ITurtle with
        ...
        member this.Position = ??  // what goes here?

        member this.PenUp() =
            penState <- ??  // what goes here?
...
// NOTE: I'm using the arrange/act/assert approach to writing tests
